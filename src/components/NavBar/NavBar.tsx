...
const NavBar = () => {
    ...
    return (
        <nav className={`fixed top-0 left-0 w-full flex items-center justify-between 2xl:h-42 xl:h-28 lg:h-28 md:px-7 lg:px-16 xl:px-40 2xl:px-60 p-5 z-50
            ${isScrolled ? "bg-footer-bg text-white shadow-md" : "bg-white-20 text-light"}
        ...
        >
            ...
            {isMenuOpen && (
                <div className="absolute top-full left-0 w-full bg-footer-bg shadow-lg p-5 z-10 flex flex-col items-center space-y-4 md:hidden">
                    <Link href="/">Home</Link>
                    <Link href="/about">About Us</Link>
                    <Link href="/tour-packages">Tour Packages</Link>
                    <Link href="/contact">Contact Us</Link>
